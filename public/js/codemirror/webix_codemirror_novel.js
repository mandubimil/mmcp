webix.protoUI({
  ...
  _render_cm_editor:function(){
    webix.require("codemirror/lib/codemirror_novel.css");
    var deps = [
    ...
    if (this.config.mode == "htmlmixed"){
      ...
      deps.push("codemirror/mode/go/go.js");
      deps.push("codemirror/mode/python/python.js");
      deps.push("codemirror/mode/sql/sql.js");
    }
